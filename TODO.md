...
- [CSS-B27] Action-Row Utility (admin_frontend/admin-ui/src/styles/utilities.css:233-238 ↔ customer_frontend/customer-ui/src/styles/utilities.css:283-288) – **B (identisch, redundant)**. Source of Truth: Admin-Utilities (visuelle Referenz); Customer-Action-Row als LEGACY kennzeichnen und auf Admin-Tokens lassen, damit Pflegepunkt entfällt.
- [CSS-B28] Pill-Row Utility (admin_frontend/admin-ui/src/styles/utilities.css:269-274 ↔ customer_frontend/customer-ui/src/styles/utilities.css:269-274) – **B (identisch, redundant)**. Source of Truth: Admin-Utilities; Customer-Pill-Row als LEGACY markieren, da keinerlei Wertabweichung (flex/wrap/gap) besteht.
- [CSS-B29] Card-Grid Utility (admin_frontend/admin-ui/src/styles/utilities.css:240-244 ↔ customer_frontend/customer-ui/src/styles/layout.css:515-516) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin card-grid (gap=space-6); Customer cards-grid nutzt größeres Gap (space-12) → als LEGACY markieren und Gap/Homing an Admin-Utilities angleichen.
- [CSS-B30] Einstellungen Form-Grid/Field Inline-Nutzung (customer_frontend/customer-ui/src/views/EinstellungenView.vue:200-265 ↔ admin_frontend/admin-ui/src/styles/utilities.css:252-262) – **B (identisch, redundant)**. Source of Truth: form-grid/field/align-self-end in admin utilities; scoped Inline-Verwendung als LEGACY markieren, da Werte identisch sind.
- [CSS-B31] TableWrap/Table Styles (admin_frontend/admin-ui/src/styles/layout.css:390-407 ↔ customer_frontend/customer-ui/src/styles/layout.css:382-400) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin TableWrap/Table (Radius/Background/THead Farben); Customer-Variante als LEGACY markieren und Tokens/Radius an Admin-Werte angleichen.
- [CSS-B32] Tag Styles (admin_frontend/admin-ui/src/styles/layout.css:373-387 ↔ customer_frontend/customer-ui/src/styles/layout.css:366-379) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Tag Tokens (`--tag-*`); Customer nutzt direkte color-mix Varianten → als LEGACY markieren und auf Tag-Tokens/Utilities mappen.
- [CSS-B33] Button Small Variants (admin_frontend/admin-ui/src/styles/layout.css:367-371 ↔ customer_frontend/customer-ui/src/styles/layout.css:360-363) – **B (identisch, redundant)**. Source of Truth: Admin-Button-Sizing; Customer `.btnPrimary.small`/`.btnGhost.small` als LEGACY kennzeichnen und Pflegepunkt streichen.
- [CSS-B34] Table Helper Styles (admin_frontend/admin-ui/src/styles/layout.css:416-433 ↔ customer_frontend/customer-ui/src/styles/layout.css:408-425) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Table-Helper (`--table-row-*`, `--muted`); Customer nutzt direkte RGBA/`--text-muted` → als LEGACY markieren und Tokens angleichen.
- [CSS-B35] Button Ghost Danger (admin_frontend/admin-ui/src/styles/layout.css:357-365 ↔ customer_frontend/customer-ui/src/styles/utilities.css:306-310) – **B (semantisch gleich)**. Source of Truth: Admin Danger-Button Tokens (`--tag-bad-*`); Customer nutzt `--danger`/`--surface-2` → als LEGACY markieren und Token-Angleichung planen.
- [CSS-B36] Form-Grid Utility (admin_frontend/admin-ui/src/styles/utilities.css:252-255 ↔ customer_frontend/customer-ui/src/styles/utilities.css:319-323) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin form-grid (minmax 240px, gap space-6); Customer nutzt 220px/space-8 → als LEGACY markieren und Grid/Gaps angleichen.
- [CSS-B37] TableWrap vs Table-Wrapper (customer_frontend/customer-ui/src/styles/layout.css:382-387 ↔ customer_frontend/customer-ui/src/styles/layout.css:548-548) – **A (identisch, redundant)**. Source of Truth: `tableWrap`; `.table-wrapper` als Legacy-Kompatibilität markieren und später entfernen.
- [CSS-B38] Detail-Card Utilities (admin_frontend/admin-ui/src/styles/utilities.css:170-231 ↔ customer_frontend/customer-ui/src/styles/utilities.css:170-216) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Detail-Card (radius/surface/label tokens); Customer-Variante als LEGACY markieren und Tokens/Spacing angleichen.
- [CSS-B39] Detail-Card Header Overrides (customer_frontend/customer-ui/src/views/ArtikelverwaltungView.vue:1155-1167 ↔ customer_frontend/customer-ui/src/styles/utilities.css:180-186) – **B (semantisch gleich)**. Source of Truth: Utility-Header; scoped Header/Actions als LEGACY markieren und auf Utilities mappen.
- [CSS-B40] Form-Grid/Field Compatibility Layer (admin_frontend/admin-ui/src/styles/utilities.css:252-260 ↔ customer_frontend/customer-ui/src/styles/layout.css:518-519) – **A (identisch, redundant)**. Source of Truth: Admin form-grid/field Utilities; Customer Compatibility-Form-Grid als LEGACY markieren.
- [CSS-B41] Field Label Styling (admin_frontend/admin-ui/src/styles/utilities.css:258-260 ↔ customer_frontend/customer-ui/src/styles/layout.css:520-520) – **A (identisch, redundant)**. Source of Truth: Admin field label styles; Customer Compatibility-Label als LEGACY markieren.
- [CSS-B42] Primary/Ghost Button Base (admin_frontend/admin-ui/src/styles/layout.css:331-355 ↔ customer_frontend/customer-ui/src/styles/layout.css:333-357) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Button Base (Shadow/Surface Tokens); Customer nutzt `--shadow-sm`/`--surface-2` → als LEGACY markieren und Tokens angleichen.
- [CSS-B43] Status Label (admin_frontend/admin-ui/src/styles/layout.css:326-329 ↔ customer_frontend/customer-ui/src/styles/layout.css:328-331) – **A (identisch, redundant)**. Source of Truth: Admin Status-Label; Customer-Duplikat als LEGACY markieren.
- [CSS-B44] Status Dot Colors (admin_frontend/admin-ui/src/styles/layout.css:323-324 ↔ customer_frontend/customer-ui/src/styles/layout.css:325-326) – **A (identisch, redundant)**. Source of Truth: Admin StatusDot Tokens; Customer-Duplikat als LEGACY markieren.
- [CSS-B45] Button Compatibility Layer (admin_frontend/admin-ui/src/styles/layout.css:331-355 ↔ customer_frontend/customer-ui/src/styles/layout.css:523-527) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Button Base; Customer `.button/.button--primary/.button--ghost` als LEGACY markieren und Tokens/Shadow angleichen.
- [CSS-B46] Actions Row Compatibility Layer (admin_frontend/admin-ui/src/styles/utilities.css:233-238 ↔ customer_frontend/customer-ui/src/styles/layout.css:516-516) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin `action-row`; Customer `.actions` als LEGACY markieren und Gap/Token angleichen.
- [CSS-B47] Input Base Styles (admin_frontend/admin-ui/src/styles/layout.css:259-275 ↔ customer_frontend/customer-ui/src/styles/layout.css:259-276) – **B (semantisch gleich, minimale Abweichung)**. Source of Truth: Admin Input Base (Radius/Focus); Customer nutzt `--input-*` Tokens/Transition → als LEGACY markieren und Tokens angleichen.
- [CSS-B48] Input Compatibility Layer (`.input.compat`) (customer_frontend/customer-ui/src/styles/layout.css:259-276 ↔ customer_frontend/customer-ui/src/styles/layout.css:521-522) – **A (identisch, redundant)**. Source of Truth: `.input` Base; `.input.compat` als Legacy-Kompatibilität markieren und später entfernen.
