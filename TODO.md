...
## Must
- Legacy-Migration Backend: fehlende Endpunkte für Reporting (`/inventory/report` inkl. Exporte), Inventur-Bulk-Update/Export, GET Bewegungen mit Filtern, Bestellungen (bestellwürdig/offen/erledigt inkl. Bestandserhöhung), Einstellungen/Firmendaten + Mass Import/Export ergänzen (siehe `docs/roadmap/MIGRATION_OLD_LM.md`).
