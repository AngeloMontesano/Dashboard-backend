...
- **Dateien je Backup:**
  - `meta.json` (Backup-Metadaten)
  - `tenant.json` oder `tenants.json` (aktuell: nur Meta-Informationen)
...
4. **Storage-Abstraktion** als mögliche Lösung (z. B. Provider-Interface für alternative Backends).
