...
- Bei Fehlern werden Jobs automatisch erneut versucht (Retry), bevor sie als fehlerhaft markiert werden.
- Optional können Betreiber Alerts via Webhook erhalten, wenn Jobs fehlschlagen.
