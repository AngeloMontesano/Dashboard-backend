...
- Listen liefern Paging-Metadaten `{total, limit, offset}`; Fehlercodes umfassen Referenz-Konflikte (`industry_in_use/category_in_use/item_in_use`) und System-Schutz (`forbidden_system_record`).
