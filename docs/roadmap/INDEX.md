...
- Globale Kataloge (B-02): [docs/openapi/GLOBAL_CATALOG.md](../openapi/GLOBAL_CATALOG.md) mit Paging-Defaults (`limit=50`, max 200), Fehlercodes (`industry_in_use/category_in_use/item_in_use/forbidden_system_record`), Status-Codes, Headerpflicht (`X-Admin-Key`) und QA/Review-Checkliste; Schemas in [docs/openapi/openapi.json](../openapi/openapi.json) nachziehen
